        ...
        <div class="inner_body">
            <div class="center_wrap container">
                ...
                <div id="detail-wrapper" class="detail_wrapper">
                    ...
                    <div class="detail_body_wrapper" level="" data-type="6,7">
                                        ...
                                        <div class="item_info_wrap">
                                            <div class="item_info_detail">
                                                ...
                                                {#<label class="item_name ">#}
                                                    ...
                                                    {#<label class="ellipsis">{{ userFile['file_name'] }}</label>#}
                                                {#</label>#}
                                                {#<label class="pl-40 ellipsis author_name">#}
                                                    {#<span>文件大小：</span><span>{{ userFile['fileSize'] }}</span>#}
                                                {#</label>#}
                                            </div>
                                            {#<div class="download_info item-action-wrapper pl-30">#}
...
{% block pageJs %}
    ...
    <script type="text/javascript">
        $(function(){
            //处理模板
            FILEMODEL.setWrapType($('.col_side_li_2_wrap.my_file_wrap .col_side_list_wrap.btn_icon_other'));
        });
    </script>
{% endblock %}
