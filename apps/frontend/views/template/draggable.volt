<div id="dragMove" class="draggable ui-widget-content dialog  move_wrapper"  >
    ...
    <div class="dialog-footer g-clearfix">
        ...
        <a class="g-button g-button-blue-large g-btn-mode g-button-move" style="float: right;">
            <span class="g-button-right">确定</span>
        </a>
        <a class="g-button g-button-blue-large g-btn-mode g-button-mul-move" style="float: right;display: none;">
            <span class="g-button-right">确定</span>
        </a>
    </div>
</div>
