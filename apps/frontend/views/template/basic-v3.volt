                ...
                <div class="col-sm-4">
                    ...
                    <div class="nav-user-info">
                        ...
                        <div class="pull-left dropdown">
                            ...
                            {% else %}
                            <a href="javascript:;" class="user-name"  data-toggle="dropdown"  id="js-user-name"  data-uid="{{ userInfo.uid }}" data-token="{{ user.user_token }}">{{ user.username }}<i class="icon-arrow"></i></a>
                            {% endif %}
