                    ...
                    <div class="news-wrap">
                        ...
                        <div class="news-edit news-content">
                            <form name="news" class="form-horizontal" onsubmit="return false;">
                                <input type="hidden" name="id" value="{% if id %}{{ id }}{% else %}0{% endif %}">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-1 control-label">标题</label>
                                    <div class="col-sm-11">
                                        <input type="text" class="form-control" value="{{ news['title'] }}" name="title" placeholder="" required="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-1 control-label">内容</label>
                                    <div class="col-sm-11">
                                        <script id="news-content" name="content" type="text/plain"> {{ news['content'] }} </script>
                                    </div>
                                </div>
                                <div class="form-group form-">
                                    ...
                                    <div class="col-sm-11">
                                        ...
                                        <input type="radio" name="status" {% if news['status']==0 %} checked{% endif %} value="0"> 显示
                                        </label>
                                        <label class="radio-inline"">
                                        <input type="radio" name="status" {% if news['status']==1 %} checked{% endif %} value="1"> 隐藏
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
