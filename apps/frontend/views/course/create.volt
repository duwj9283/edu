        ...
        <div class="center_wrap container">
            ...
            <div class="body_container">
                    ...
                    <div  class="tab-content">
                        <div class="tab-pane in active modify_content_wra p" id="course-info">
                            <div class="editCon" id="course-container" course = ''>
                                ...
                                <div class="edit-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control course_name" name="course_name" >
                                        </div>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control  course_title" name="course_title">
                                        </div>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea class="form-control course_desc"rows="5" placeholder="请输入课程描述"></textarea>
                                        </div>
                                        <div class="col-sm-4">
                                            <p class="form-control-static msg">最多500字</p>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <div id="ue-container" name="ue-container"></div>
                                        </div>
                                    </div>
                                    <!--<div class="form-group">-->
                                    <!--<label  class="col-sm-2 control-label">课程费用</label>-->
                                    <!--<div class="col-sm-9">-->
                                    <!--<label class="radio-inline has-select  " for="course-free">-->
                                    <!--<i class="btn_check"></i>-->
                                    <!--<input type="radio" name="radioOption" id="course-free" value="0" checked   />免费-->
                                    <!--</label>-->
                                    <!--<label class="radio-inline " for="course-pay">-->
                                    <!--<i class="btn_check"></i>-->
                                    <!--<input type="radio" name="radioOption" id="course-pay" value="1" />收费-->
                                    <!--</label>-->
                                    <!--<label id="cost-input"  style="display:none;"   >-->
                                    <!--<input  style="width:100px;display:inherit;" class="form-control  course_cost" ">-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <label class="radio-inline has-select" for="course-no-serialize">
                                                <i class="btn_check"></i>
                                                <input type="radio" name="statusRadioOption" id="course-no-serialize" value="1"  checked   />非连载课程
                                            </label>
                                            <label class="radio-inline " for="course-serialize-ing">
                                                <i class="btn_check"></i>
                                                <input type="radio" name="statusRadioOption" id="course-serialize-ing" value="2"    />连载中
                                            </label>
                                            <label class="radio-inline " for="course-serialized">
                                                <i class="btn_check"></i>
                                                <input type="radio" name="statusRadioOption" id="course-serialized" value="3"   />完结课程
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <!--<div class="tab-pane fade" id="course-intro">-->
                        ...
                        <div class="tab-pane" id="lesson-manage">
                            <div class="course_tab_container" id="lesson-edit-container" course = ''>
                                ...
                                <div class="edit-body course_detail_container">
                                            ...
                                            <li class="chapter_wrapper chapter_add_wrap" chapter="0">
                                                <div class="chapter_header">
                                                    <div class="title_wrap drag-chapter">
                                                        ...
                                                        <input class="chapter_name input-no-editor" placeholder="输入章节名"></div><label class="orange add_lesson">
                                                ...
                                                <ul class="lesson_area sort-lesson ui-sortable">
                                                    <li class="lesson_wrap title_wrap w_l drag-lesson selected" lesson="0" data-files_kj="" data-files_zl="" data-exam="">
                                                        <div class="course_ac_icons" ><div class="course-icon-bg">
                                                                ...
                                                                <label class="choose-label for-xt" title="上传习题"><i class="icon btn_edit"></i></label>
                                                                <label class="choose-label for-zl"  title="上传资料"><i class="icon btn_file_zl"></i></label>
                                                                <label class="choose-label for-kj" title="上传课件"><i class="icon btn_file_kj"></i></label></div>
                                                        </div>
                                                        <i class="c_l"></i>
                                                ...
                                                <li class="chapter_wrapper " chapter={{ lessons['lesson']['id'] }}>
                                                    ...
                                                    <ul class="lesson_area sort-lesson">
                                                        {% for child in lessons['child_list'] %}
                                                            <li class="lesson_wrap title_wrap w_l  drag-lesson" lesson={{ child['id'] }} zl_files='{{ child['file_ids'] }}' kj_file="{{ child['file'] }}">
                                                                <div class="course_ac_icons" ><div class="course-icon-bg">
                                                                        <label class="choose-label" title="删除"><i class="icon btn_del"></i></label>
                                                                        ...
                                                                        <label class="choose-label for-kj" title="上传课件"><i class="icon btn_file_kj {% if child['file'] != '' %}btn_file_kj_active{% endif %}"></i></label></div>
                                                                </div>
                                                                <i class="c_l"></i>
